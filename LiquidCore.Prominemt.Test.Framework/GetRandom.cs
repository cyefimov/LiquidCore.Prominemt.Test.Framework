...
public static class GetRandom
{
    ...
    /// <returns>A <see cref="byte"/> value greater than or equal to <paramref name="minValue"/>, and less than <paramref name="maxValue"/>.</returns>
    public static byte Byte(byte minValue, byte maxValue) => Byte(minValue, maxValue, null);

    /// <summary>Returns a nonnegative random <see cref="byte"/> value within the specified range, excluding the specified value.</summary>
    /// <param name="minValue">The inclusive lower bound of the random number returned.</param>
    /// <param name="maxValue">The exclusive upper bound of the random number returned. maxValue must be greater than or equal to minValue.</param>
    ...
    /// <returns>A <see cref="byte"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>, and not equal to <paramref name="exclude"/>.</returns>
    ...
    /// <param name="exclude">A value that should not be returned, used when you want to get a value other than one you already have.</param>
    public static string CityName(string exclude = null!) => Element(Names.Cities, exclude);
    ...
    /// <param name="minValue">The minimum desired value.</param>
    /// <param name="maxValue">The maximum desired value.</param>
    /// <returns>A <see cref="System.DateTime"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>.</returns>
    ...
    /// <param name="maxValue">The maximum desired value.</param>
    /// <param name="exclude">A value that should not be returned, used when you want to get a value other than one you already have.</param>
    /// <returns>A <see cref="System.DateTime"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>, and not equal to <paramref name="exclude"/>.</returns>
    ...
    /// <summary>Returns a random date from <paramref name="daysInThePast"/> days ago to <paramref name="daysInTheFuture"/> from now.</summary>
    ...
    /// <summary>Returns a nonnegative random <see cref="decimal"/> value within the specified range, excluding the specified value.</summary>
    ...
    /// <returns>A <see cref="decimal"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>.</returns>
    ...
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <param name="exclude">A value that should not be returned, used when you want to get a value other than one you already have.</param>
    /// <returns>A <see cref="decimal"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>, and not equal to <paramref name="exclude"/>.</returns>
    ...
    /// <summary>Returns a nonnegative random <see cref="double"/> value within the specified range, excluding the specified value.</summary>
    /// <param name="minValue">The inclusive lower bound of the random value returned.</param>
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <returns>A <see cref="double"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>.</returns>
    ...
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <param name="exclude">A value that should not be returned, used when you want to get a value other than one you already have.</param>
    /// <returns>A <see cref="double"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>, and not equal to <paramref name="exclude"/>.</returns>
    ...
    public static T Element<T>(IEnumerable<T> list)
    {
        ...
        return enumerable.ElementAt(Int32(enumerable.Count));
    }
    ...
    public static TEnum EnumValue<TEnum>()
    {
        ...
        return !enumType.IsEnum ? throw new ArgumentException("TEnum must be an enumeration.") : Element((IEnumerable<TEnum>)Enum.GetValues(enumType));
    }
    ...
    {
        var enumType = typeof(TEnum);
        return !enumType.IsEnum ? throw new ArgumentException("TEnum must be an enumeration.") : Element((IEnumerable<TEnum>)Enum.GetValues(enumType), exclude);
    }
    ...
    public static string FirstName(bool? male = null) => Element(male ?? Bool() ? Names.Male : Names.Female);

    public static string GetStringPrefix() => _stringPrefix;
    ...
    /// </remarks>
    public static int SeqId() => _nextId++;
    ...
    /// <summary>Returns a nonnegative random <see cref="short"/> value within the specified range, excluding the specified value.</summary>
    /// <param name="minValue">The inclusive lower bound of the random value returned.</param>
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <returns>A <see cref="short"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>.</returns>
    ...
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <param name="exclude">A value that should not be returned, used when you want to get a value other than one you already have.</param>
    /// <returns>A <see cref="short"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>, and not equal to <paramref name="exclude"/>.</returns>
    ...
    /// <summary>Returns a nonnegative random <see cref="int"/> value within the specified range, excluding the specified value.</summary>
    /// <param name="minValue">The inclusive lower bound of the random value returned.</param>
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <returns>A <see cref="int"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>.</returns>
    ...
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <param name="exclude">A value that should not be returned, used when you want to get a value other than one you already have.</param>
    /// <returns>A <see cref="int"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>, and not equal to <paramref name="exclude"/>.</returns>
    ...
    /// <summary>Returns a nonnegative random <see cref="long"/> value within the specified range, excluding the specified value.</summary>
    /// <param name="minValue">The inclusive lower bound of the random value returned.</param>
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <returns>A <see cref="long"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>.</returns>
    ...
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <param name="exclude">A value that should not be returned, used when you want to get a value other than one you already have.</param>
    /// <returns>A <see cref="long"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>, and not equal to <paramref name="exclude"/>.</returns>
    ...
    public static string LastName() => Element(Names.Last);
    ...
    /// <remarks>This method is meant to provide for some consistency in how unit tests are written. It doesn't do anything that "new T()" wouldn't have provided, but makes the code "read" more consistently.</remarks>
    public static T Object<T>() where T : class, new() => new T();
    ...
    /// </remarks>
    public static void SetStringPrefix(string value) => _stringPrefix = value;
    ...
    /// <summary>Returns a nonnegative random <see cref="float"/> value within the specified range, excluding the specified value.</summary>
    /// <param name="minValue">The inclusive lower bound of the random value returned.</param>
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <returns>A <see cref="float"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>.</returns>
    ...
    /// <param name="maxValue">The exclusive upper bound of the random value returned. maxValue must be greater than or equal to minValue.</param>
    /// <param name="exclude">A value that should not be returned, used when you want to get a value other than one you already have.</param>
    /// <returns>A <see cref="float"/> value greater than or equal to <paramref name="minValue"/>, less than <paramref name="maxValue"/>, and not equal to <paramref name="exclude"/>.</returns>
    ...
    public static string String() => String(1, 50, null!);
    ...
    public static string String(int maxLength) => String(1, maxLength, null!);
    ...
    /// <summary>Returns a random email string with a unique part length in the specified range.</summary>
    /// <param name="minLength">The inclusive lower bound for the unique part length of the string to be returned.</param>
    /// <param name="maxLength">The exclusive upper bound for the unique part length of the string to be returned.</param>
    /// <returns>A random email string with a unique part length in the specified range.</returns>
    public static string Email(int minLength = 1, int maxLength = 50) => $"{String(minLength, maxLength)}@{String(minLength, maxLength)}.com";
